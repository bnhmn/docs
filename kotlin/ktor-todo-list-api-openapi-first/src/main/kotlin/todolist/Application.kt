...
import todolist.api.TodoControllerImpl
import todolist.api.controllers.TodosController
import todolist.api.controllers.TodosController.Companion.todosRoutes
...
fun Application.module() {
    ...
    install(Koin) {
        modules(
            module {
                single<TodosController> { TodoControllerImpl(service = get()) }
